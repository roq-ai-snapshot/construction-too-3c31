  ...
  return (
    <Box h={isBannerVisible ? 'calc(100vh - 40px)' : '100vh'} bg={'base.100'}>
      ...
      >
        <DrawerContent>
          <SidebarContent
            top={{ base: isBannerVisible ? '85px' : 0, sm: isBannerVisible ? '60px' : 0 }}
            h={{
              base: isBannerVisible ? 'calc(100vh - 85px)' : 'full',
              sm: isBannerVisible ? 'calc(100vh - 60px)' : 'full',
            }}
            onClose={onClose}
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Outlets', path: '/outlets', entity: 'outlet', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Rentals', path: '/rentals', entity: 'rental', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Tools', path: '/tools', entity: 'tool', service: AccessServiceEnum.PROJECT, icon: FiTool },
